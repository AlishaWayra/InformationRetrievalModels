...
Out of up to 1'000 passages, the models retrieve at most 100 passages for each query. At the end, a *.csv* file is created for each model with each query and the top 100 passages in ascending order depending on their score.
